...
type PostRegisterParams struct {
	...
	/* Request.
	   ...
	   Данные пользователя
	*/
	Request *models.HTTPUserRequest
...
// WithRequest adds the request to the post register params
func (o *PostRegisterParams) WithRequest(request *models.HTTPUserRequest) *PostRegisterParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the post register params
func (o *PostRegisterParams) SetRequest(request *models.HTTPUserRequest) {
	o.Request = request
}
